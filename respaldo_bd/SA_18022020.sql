...
INSERT INTO `conf_menu` VALUES (23,0,5,'Configuraciones','#','fas fa-fw fa-cog','#','#','#',97),(24,0,4,'Reportes Especiales','#','fas fa-fw fa-wrench','#','#','#',97),(25,0,3,'Registro Notas','#','fas fa-fw fa-chart-area','#','#','#',97),(26,0,2,'Matricula','#','fas fa-fw fa-table','#','#','#',97),(27,0,1,'Admision','#','fas fa-fw fa-folder','#','#','#',97),(28,27,13,'Mantenimiento','Academico:Personas','fas fa-fw fa-folder','mantenimiento_personas/','Personas','mantenimientoPersonas',97),(29,27,14,'Movimientos','Academico:movimientos','fas fa-fw fa-folder','movimientos/','movimientos','movimientos',97),(30,27,15,'Consultas','Academico:consultas','fas fa-fw fa-folder','consultas/','consultas','consultas',97),(31,27,16,'Procesos','Academico:procesos','fas fa-fw fa-folder','procesos/','procesos','procesos',97),(32,27,17,'Reportes','Academico:reportes','fas fa-fw fa-folder','reportes/','reportes','reportes',97),(33,23,2,'Usuarios','Academico:usuarios','fas fa-fw fa-cog','usuarios/','usuarios','usuarios',97),(34,23,3,'Roles','Academico:roles','fas fa-fw fa-cog','roles/','roles','roles',97),(35,23,4,'Perfiles','Academico:perfiles','fas fa-fw fa-cog','perfiles/','perfiles','perfiles',97),(36,23,5,'Menu','Academico:menu','fas fa-fw fa-cog','menu/','menu','menu',97),(37,23,6,'Modulo','Academico:modulo','fas fa-fw fa-cog','modulo/','modulo','modulo',97),(38,23,7,'Acciones','Academico:acciones','fas fa-fw fa-cog','acciones/','acciones','acciones',97),(40,23,8,'Empresa','Academico:empresas','fas fa-fw fa-cog','empresas/','empresas','empresas',97),(51,27,6,'Ejemplo','Academico:ejemplo','fas fa-fw fa-folder','ejemplo/','ejemplo','ejemplo',97),(52,27,6,'ejemplo','Academico:ejemplo2','fas fa-fw fa-folder','ejemplo2','ejemplo2','ejemplo2',97);
...
CREATE TABLE `conf_permiso` (
  ...
  KEY `conf_permiso_id_rol_idx` (`id_rol`),
...
INSERT INTO `conf_permiso` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,1),(6,6,1),(7,7,1),(8,8,1),(9,9,1),(16,10,1),(17,11,1),(18,12,1),(19,13,1),(20,14,1);
...
INSERT INTO `conf_usuario` VALUES (8,'nelio','ce01b883461bb771a6085503655b87613a843e9b',97,21,1),(50,'Josue','145a6fa2632f101836877c4365dd93627aee7c35',97,19,1),(53,'Jaime','5803568d61bc07bd5a6cf1a2c18b3b94e325dddc',97,22,1),(64,'Peralta','8d51746f97f8d5d14f101105ee1544e6ffcedbcf',97,21,1),(65,'josue','9959c10cadf3b51950519e7ceb2e302a2b76b4be',97,21,1);
...
CREATE TABLE `mant_persona` (
  ...
  `id_genr_tipo_usuario` int(11) NOT NULL,
  `rdireccion_trabajo` varchar(200),
  `rhorario_laboral` varchar(40),
  `rtelefono_trabajo` varchar(20),
...
-- Dump completed on 2020-02-18 10:26:06
