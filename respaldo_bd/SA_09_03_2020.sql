...
INSERT INTO `conf_menu` VALUES (23,0,5,'Configuraciones','#','fas fa-fw fa-cog','#','#','#',97),(24,0,4,'Reportes Especiales','#','fas fa-fw fa-wrench','#','#','#',97),(25,0,3,'Registro Notas','#','fas fa-fw fa-chart-area','#','#','#',97),(26,0,2,'Matricula','#','fas fa-fw fa-table','#','#','#',97),(27,0,1,'Admision','#','fas fa-fw fa-folder','#','#','#',97),(28,27,13,'Mantenimiento','#','fas fa-fw fa-folder','#','#','#',97),(29,27,14,'Movimientos','Academico:movimientos','fas fa-fw fa-folder','movimientos/','movimientos','movimientos',97),(30,27,15,'Consultas','Academico:consultas','fas fa-fw fa-folder','consultas/','consultas','consultas',97),(31,27,16,'Procesos','Academico:procesos','fas fa-fw fa-folder','procesos/','procesos','procesos',97),(32,27,17,'Reporte Mant','Academico:reportes','fas fa-fw fa-folder','reportes/','reportes','reportes',97),(33,23,2,'Usuarios','Academico:usuarios','fas fa-fw fa-cog','usuarios/','usuarios','usuarios',97),(34,23,3,'Roles','Academico:roles','fas fa-fw fa-cog','roles/','roles','roles',97),(35,23,4,'Permisos','Academico:permisos','fas fa-fw fa-cog','perfiles/','permisos','perfiles',97),(36,23,5,'Menu','Academico:menu','fas fa-fw fa-cog','menu/','menu','menu',97),(37,23,6,'Modulo','Academico:modulo','fas fa-fw fa-cog','modulo/','modulo','modulo',97),(38,23,7,'Acciones','Academico:acciones','fas fa-fw fa-cog','acciones/','acciones','acciones',97),(40,23,8,'Unidad','Academico:empresas','fas fa-fw fa-cog','empresas/','empresas','empresas',97),(45,28,1,'Estudiantes','Academico:estudiante','fas fa-fw fa-folder','estudiante/','estudiante','Estudiante',97),(46,28,2,'Empleados','Academico:empleado','fas fa-fw fa-folder','empleado/','empleado','Empleado',97),(47,23,10,'Reporte Conf','#','fas fa-fw fa-cog','#','#','#',97),(48,47,1,'Reporte Usuario','Academico:reporte_usuarios','fas fa-fw fa-cog','reporte_usuarios/','reporte_usuarios','reporte_usuarios',97),(49,47,2,'Reporte Rol','Academico:reporte_roles','fas fa-fw fa-cog','reporte_roles/','reporte_roles','reporte_roles',97);
...
INSERT INTO `conf_permiso` VALUES (1,3);
...
INSERT INTO `conf_permiso_menu` VALUES (2,1,23),(10,1,24),(11,1,25),(12,1,26),(13,1,27),(14,1,28),(15,1,29),(16,1,30),(17,1,31),(5,1,32),(3,1,33),(6,1,34),(1,1,35),(22,1,36),(7,1,37),(8,1,38),(9,1,40),(23,1,45),(24,1,46),(25,1,47),(26,1,48),(27,1,49);
...
) ENGINE=InnoDB AUTO_INCREMENT=1750 ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-09 17:28:37
