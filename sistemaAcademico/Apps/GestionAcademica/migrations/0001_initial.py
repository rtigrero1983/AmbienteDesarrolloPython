# Generated by Django 2.2.5 on 2020-02-01 22:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_genr_estado', models.ForeignKey(db_column='id_genr_estado', on_delete=django.db.models.deletion.CASCADE, related_name='fk_accion_genr', to='GestionAcademica.GenrGeneral')),
                ('id_menu', models.ForeignKey(db_column='id_menu', on_delete=django.db.models.deletion.CASCADE, related_name='fk_accion_menu', to='GestionAcademica.ConfMenu')),
            ],
            options={
                'verbose_name': 'Accion',
