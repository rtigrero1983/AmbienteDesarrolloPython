# Generated by Django 2.2.5 on 2020-02-27 22:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_rol', models.ForeignKey(db_column='id_rol', default=1, on_delete=django.db.models.deletion.CASCADE, related_name='fk_permiso_rol', to='GestionAcademica.ConfRol')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='confaccion',
            name='id_menu',
            field=models.ManyToManyField(blank=True, db_column='id_menu', to='GestionAcademica.ConfMenu'),
        ),
    ]
