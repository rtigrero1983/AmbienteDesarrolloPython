# Generated by Django 2.2.5 on 2020-01-09 21:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idconf_usuario_rol', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='confmenu',
            name='id_modulo',
            field=models.ForeignKey(db_column='id_modulo', on_delete=django.db.models.deletion.CASCADE, related_name='fk_menu_modulo', to='GestionAcademica.ConfModulo'),
        ),
        migrations.CreateModel(
            name='ConfEmpresa',
            fields=[
        ...
        migrations.CreateModel(
            name='Conf_rol_permiso',
            fields=[
                ('idconf_rol_permiso', models.AutoField(primary_key=True, serialize=False)),
                ('id_permiso_rol', models.ForeignKey(db_column='id_permiso_rol', on_delete=django.db.models.deletion.CASCADE, related_name='fk_permiso_rol', to='GestionAcademica.ConfPermiso')),
                ('id_rol', models.ForeignKey(db_column='id_rol', on_delete=django.db.models.deletion.CASCADE, related_name='fk_detalle_rol', to='GestionAcademica.ConfRol')),
            ],
            options={
