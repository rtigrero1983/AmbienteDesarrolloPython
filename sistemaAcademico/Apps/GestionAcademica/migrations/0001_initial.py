# Generated by Django 2.2.5 on 2020-09-10 16:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_matriculacion_estudiante', models.ForeignKey(blank=True, db_column='id_matriculacion_estudiante', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_detalleregistronotas_matriestudiante', to='GestionAcademica.MovMatriculacionEstudiante')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_materia_profesor', models.ForeignKey(blank=True, db_column='id_materia_profesor', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_cabregistronotas_materiaprofesor', to='GestionAcademica.Mov_Materia_profesor')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='id_genr_paralelo', on_delete=django.db.models.deletion.CASCADE, related_name='fk_mavaniolectivo_curso_genrparalelo', to='GestionAcademica.GenrGeneral'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name='mov_aniolectivo_curso',
            constraint=models.UniqueConstraint(fields=('id_anio_electivo', 'id_curso'), name='Unicos'),
        ),
    ]
