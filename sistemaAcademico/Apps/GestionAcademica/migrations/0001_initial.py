# Generated by Django 2.2.5 on 2021-02-17 23:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_persona', models.ForeignKey(db_column='id_persona', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fk_persona_usuario_tem', to='GestionAcademica.MantPersona')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ssl', models.CharField(default='True', max_length=30)),
