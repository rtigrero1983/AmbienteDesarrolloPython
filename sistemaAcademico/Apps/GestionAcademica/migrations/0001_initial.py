# Generated by Django 2.2.5 on 2020-10-21 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.CharField(max_length=150, validators=[sistemaAcademico.Apps.Validaciones.validar_espacios])),
                ...
                ('imagen', models.ImageField(default='../../../static/img/texto-menu.pnguser_default_image.svg', upload_to='static/usuarios/')),
                ...
                ('rcorreo', models.EmailField(max_length=50)),
        ...
        migrations.AddConstraint(
            model_name='mov_aniolectivo_curso',
            constraint=models.UniqueConstraint(fields=('id_anio_electivo', 'id_curso', 'id_genr_paralelo'), name='Unicos'),
        ),
    ]
