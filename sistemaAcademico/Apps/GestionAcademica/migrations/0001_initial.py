# Generated by Django 2.2.5 on 2020-08-24 17:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_genr_paralelo', models.ForeignKey(db_column='id_genr_paralelo', on_delete=django.db.models.deletion.CASCADE, related_name='fk_asignacion_paralelo', to='GestionAcademica.GenrGeneral')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_detalle_materia_curso', models.ManyToManyField(db_table='mov_profesor_materiacurso', related_name='fk_materia_profesor', to='GestionAcademica.MovDetalleMateriaCurso')),
                ('id_empleado', models.ForeignKey(db_column='id_empleado', on_delete=django.db.models.deletion.CASCADE, related_name='fk_materiaprof_empleado', to='GestionAcademica.MantEmpleado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_anio_lectivo', models.ForeignKey(db_column='id_anio_lectivo', on_delete=django.db.models.deletion.CASCADE, related_name='fk_horario_docente_anio_lectivo', to='GestionAcademica.MantAnioLectivo')),
                ('id_docente', models.ForeignKey(db_column='id_docente', on_delete=django.db.models.deletion.CASCADE, related_name='fk_horario_docente_docente', to='GestionAcademica.MantPersona')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_curso', models.ForeignKey(db_column='id_curso', on_delete=django.db.models.deletion.CASCADE, to='GestionAcademica.MovCabCurso')),
                ('id_estado_gnral', models.ForeignKey(db_column='estado', default=97, on_delete=django.db.models.deletion.CASCADE, to='GestionAcademica.GenrGeneral')),
                ('id_genr_paralelo', models.ManyToManyField(db_column='id_genr_paralelo', related_name='fk_cabcurso_paralelo', to='GestionAcademica.GenrGeneral')),
            ],
            options={
