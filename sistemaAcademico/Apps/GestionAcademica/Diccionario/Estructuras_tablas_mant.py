...
class MantPersona(models.Model):
    ...
    id_genr_genero = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=True, related_name="genero", db_column='id_genr_genero')
    id_genr_pais = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=True, db_column='id_genr_pais')
    id_genr_provincia = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="provincia", db_column='id_genr_provincia',null=True)
    id_genr_ciudad = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="ciudad", db_column='id_genr_ciudad',null=True)
    id_genr_tipo_sangre = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="tipo_de_sangre", db_column='id_genr_tipo_sangre',null=True)
    id_genr_etnia = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="etnia", db_column='id_genr_etnia',null=True)
    ...
    imagen = models.ImageField(upload_to='static/usuarios/',blank=False, null=True,default='../../../static/img/texto-menu.pnguser_default_image.svg')
    ...
    id_genr_tipo_identificacion = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="identificacion", db_column='id_genr_tipo_identificacion',null=True)
...
class MantAnioLectivo(models.Model):
    ...
    id_genr_estado = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=False,
                                       related_name="fk_aniolectivo_estado", db_column='id_genr_estado', validators=[anio_lectivos])
