...
class MantPersona(models.Model):
    ...
    id_genr_estado_laboralp = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="estado_laboralp", db_column='id_genr_estado_laboralp', blank=True, null=True)
    ...
    pvive_con_usted = models.BooleanField(blank=True, null=True, default=0)
    id_genr_estado_laboralm = models.ForeignKey(GenrGeneral,blank=True, null=True, on_delete=models.CASCADE, related_name="estado_laboralm", db_column='id_genr_estado_laboralm', default=0)
    ...
    mvive_con_usted = models.BooleanField(blank=True, null=True, default=0)
    ...
    id_genr_tipo_parentesco = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE,blank=True, null=True, related_name="tipo_parentesco", db_column='id_genr_tipo_parentesco', default=0)
    rvive_con_usted = models.BooleanField(blank=True, null=True, default=0)
