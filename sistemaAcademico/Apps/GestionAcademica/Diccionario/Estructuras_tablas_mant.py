...
class MantPersona(models.Model):
    ...
    id_genr_tipo_parentesco = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE,blank=True, null=True, related_name="tipo_parentesco", db_column='id_genr_tipo_parentesco')
